...
Name2Difficulty = {
    DIFFICULTIES_AS_NAMES[0]:DIFFICULTY_EASY,
    DIFFICULTIES_AS_NAMES[1]:DIFFICULTY_MEDIUM,
    DIFFICULTIES_AS_NAMES[2]:DIFFICULTY_HARD
    }
Difficulty2Name = {
    DIFFICULTY_EASY:DIFFICULTIES_AS_NAMES[0],
    DIFFICULTY_MEDIUM:DIFFICULTIES_AS_NAMES[1],
    DIFFICULTY_HARD:DIFFICULTIES_AS_NAMES[2]
    }
