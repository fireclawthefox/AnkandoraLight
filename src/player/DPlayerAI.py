...
class DPlayerAI(DistributedObjectAI):
    def __init__(self, air):
        ...
        self.room = None
        self.ignorePathCostRequest = False
    ...
    def requestPathCost(self, fieldName):
        if self.ignorePathCostRequest: return
        cost = self.room.boardAI.getMinCostOfPathToFieldName(self.currentField, fieldName)
        self.sendUpdateToAvatarId(self.avId, "doSetPathCost", [cost])
